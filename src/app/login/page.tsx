  ...
  return (
    <div className="min-h-screen pt-20 pb-12 flex items-center justify-center">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute top-1/4 -left-32 w-96 h-96 bg-[var(--accent-color)]/10 rounded-full blur-3xl" />
      ...
      <div className="w-full max-w-md px-4">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 mb-6 group">
            <div className="w-10 h-10 rounded-xl bg-[var(--accent-subtle)] flex items-center justify-center transition-transform group-hover:scale-105">
        ...
        <div className="card p-8">
          {/* Error Alert */}
          {error && (
            <div className="mb-6 p-4 rounded-xl bg-[var(--error-color)]/10 border border-[var(--error-color)]/20">
              <div className="flex items-start gap-3">
                <svg className="w-5 h-5 text-[var(--error-color)] shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              className="btn btn-secondary h-11 text-sm font-medium"
              onClick={() => {/* Future: Google OAuth */}}
            >
