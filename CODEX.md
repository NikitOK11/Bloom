...
- Активное UI-направление: dark campus / premium academic, Russian-first UX, event-first каталог; визуальные PR оставлять маленькими и пушить напрямую в `origin main`.
