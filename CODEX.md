...
- Каждый завершенный PR-sized change сразу коммитить и пушить в репозиторий пользователя.
...
## 10) Domain baseline
- `Event` — центральная сущность каталога событий; типы событий включают олимпиады, хакатоны и кейс-чемпионаты.
