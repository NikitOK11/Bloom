...
- Сценарий 1: поддержка олимпиад и командной работы (участники, команды, процессы вокруг олимпиад).
- Сценарий 2: приватные соревнования по ссылке с ограниченным доступом к данным и участникам.
- Team всегда привязана к Olympiad (Team.olympiad non-nullable).
